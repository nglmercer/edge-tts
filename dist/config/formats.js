...
exports.FORMAT_CONTENT_TYPE = exports.ALL_AUDIO_FORMATS = exports.AUDIO_FORMATS_NON_STREAM = exports.AUDIO_FORMATS_STREAM = void 0;
exports.AUDIO_FORMATS_STREAM = {
    // RAW PCM
...
exports.AUDIO_FORMATS_NON_STREAM = {
    // RIFF (WAV)
...
const ALL_AUDIO_FORMATS = { ...exports.AUDIO_FORMATS_STREAM, ...exports.AUDIO_FORMATS_NON_STREAM };
exports.ALL_AUDIO_FORMATS = ALL_AUDIO_FORMATS;
const FORMAT_CONTENT_TYPE = new Map(Object.entries(ALL_AUDIO_FORMATS));
exports.FORMAT_CONTENT_TYPE = FORMAT_CONTENT_TYPE;
